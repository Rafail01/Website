...
export const AboutPage: FC = () =>
  <>
    ...
    <p>Λειτουργούν τμήματα παιδικά και ενηλίκων για αρχάριους αλλά και πιο έμπειρους χορευτές. Διδάσκονται παραδοσιακοί
      ...
      λειτουργεί και ερασιτεχνική θεατρική ομάδα.</p>

    <div className="contact">
      <h2>Επικοινωνία</h2>
      <p>Τηλέφωνα: 6944982331, 6947144443</p>
      <p>Email: <a href="mailto:leukippos.h.o.manis@gmail.com">leukippos.h.o.manis@gmail.com</a></p>
    </div>
